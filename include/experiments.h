...
private:
  ...
  const static double constexpr MUP = 0.000002;
  const static double constexpr MUC = 0.0005;
  const static double constexpr GRAVITY= -9.8;
  const static double constexpr MASSCART= 1.0;
  const static double constexpr MASSPOLE_1= 0.1;

  const static double constexpr LENGTH_1= 0.5;		  /* actually half the pole's length */

  const static double constexpr FORCE_MAG= 10.0;
  const static double constexpr TAU= 0.01;		  //seconds between state updates

  const static double constexpr one_degree= 0.0174532;	/* 2pi/360 */
  const static double constexpr six_degrees= 0.1047192;
  const static double constexpr twelve_degrees= 0.2094384;
  const static double constexpr fifteen_degrees= 0.2617993;
  const static double constexpr thirty_six_degrees= 0.628329;
  const static double constexpr fifty_degrees= 0.87266;
